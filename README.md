...
The back-end is a Flask (Python) REST api that also makes api calls to get the full info from either the audiodb https://www.theaudiodb.com/api_guide.php or lastfm REST api's https://www.last.fm/api
